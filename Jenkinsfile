pipeline {
    ...
    environment {
        JMETER_HOME_WIN = "C:/Users/moondaeng/Desktop/practice/apache-jmeter-5.6.3"
        ...
        stage('Checkout JMX from GitHub') {
            steps {
                git branch: 'main',
                    ...
                    url: 'https://github.com/Moondaeng/test-jenkins-jmeter-main-0814.git'
            }
        }
            ...
            steps {
                script {
                    ...
                    if (isUnix()) {
                        ...
                        jmxFile = bat(
                            script: '@echo off\r\nfor %%f in (*.jmx) do @echo %%f & goto :eof',
                            returnStdout: true
                        ).trim()
                    }
